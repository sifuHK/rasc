...
## resource
[English Documents,Tutorials and Examples (Version = 2026.1.19)](https://github.com/sifuHK/rasc/tree/main/2026.1.19)  
[Chinese Documents, Tutorials, and Examples (version = 2026.1.19)](https://gitee.com/sifuHK/rasc/tree/master/2026.1.19)
## Install
pip install --upgrade rascpy
## Notes
1. In principle, projects generated by any version of rascpy are backward compatible. This means it is feasible to load a project created by an older version using the latest version of rascpy via `ScoreCard.CardFlow.start(load_step)`. However, if an error occurs after loading, you will need to rerun the project with the version of rascpy you are currently using.
1. If your interactive language changes, previously created projects must be rerun before they can be loaded again.
...
[English all_instructions_detailed_desc.txt](https://github.com/sifuHK/rasc/blob/main/2026.1.19/all_instructions_detailed_desc.txt)  
[中文全部指令详细说明.txt](https://gitee.com/sifuHK/rasc/blob/master/2026.1.19/全部指令详细说明.txt)  
